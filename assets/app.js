!(function(e) {
    ...
    (function() {
      ...
      var u = this,
        ...
        v = function(e) {
          return e instanceof v
            ? e
            : this instanceof v ? void (this._wrapped = e) : new v(e);
        };
      ...
      var m = function(e, t, n) {
        ...
        H = function(e, t, n) {
          return null == e
            ...
            : v.isFunction(e)
              ? m(e, t, n)
              : v.isObject(e) ? v.matcher(e) : v.property(e);
        };
      ...
      var y = function(e, t) {
          return function(n) {
            ...
            for (var i = 1; i < r; i++)
              for (
                var o = arguments[i], a = e(o), l = a.length, u = 0;
                u < l;
                u++
              ) {
                var s = a[u];
      ...
      (v.each = v.forEach = function(e, t, n) {
        ...
        (v.find = v.detect = function(e, t, n) {
          var r;
          if (
            ((r = I(e) ? v.findIndex(e, t, n) : v.findKey(e, t, n)),
            void 0 !== r && r !== -1)
          )
            return e[r];
        }),
        ...
        (v.every = v.all = function(e, t, n) {
          t = H(t, n);
          for (
            var r = !I(e) && v.keys(e), i = (r || e).length, o = 0;
            o < i;
            o++
          ) {
            var a = r ? r[o] : o;
      ...
      (v.groupBy = w(function(e, t, n) {
        ...
        (v.toArray = function(e) {
          return e
            ? v.isArray(e)
              ? b.call(e)
              : I(e) ? v.map(e, v.identity) : v.values(e)
            : [];
        }),
        (v.size = function(e) {
      ...
      (v.flatten = function(e, t) {
        ...
        (v.uniq = v.unique = function(e, t, n, r) {
          ...
          for (var i = [], o = [], a = 0, l = C(e); a < l; a++) {
            ...
            t
              ? ((a && o === s) || i.push(u), (o = s))
              : n
                ? v.contains(o, s) || (o.push(s), i.push(u))
        ...
        (v.unzip = function(e) {
          for (
            var t = (e && v.max(e, C).length) || 0, n = Array(t), r = 0;
            r < t;
            r++
          )
            n[r] = v.pluck(e, r);
      ...
      (v.bind = function(e, t) {
        if (h && e.bind === h) return h.apply(e, b.call(arguments, 1));
        if (!v.isFunction(e))
        ...
        (v.debounce = function(e, t, n) {
          var r,
            ...
            u = function() {
              ...
              s < t && s >= 0
                ? (r = setTimeout(u, t - s))
                : ((r = null), n || ((l = e.apply(o, i)), r || (o = i = null)));
            };
          return function() {
      ...
      (v.keys = function(e) {
        ...
        (v.clone = function(e) {
          return v.isObject(e)
            ? v.isArray(e) ? e.slice() : v.extend({}, e)
            : e;
        }),
        (v.tap = function(e, t) {
          return t(e), e;
      ...
      var N = function(e, t, n, r) {
        ...
        if ((n.push(e), r.push(t), o)) {
          ...
          for (; u--; )
            if (((s = c[u]), !v.has(t, s) || !N(e[s], t[s], n, r))) return !1;
        }
      ...
      function e() {
        ...
        i(this, e),
          ...
          (this.currentScroll = function() {
            return t._dirty
              ? ((t._dirty = !1),
                (t._scrollTop = document.scrollingElement.scrollTop))
              : t._scrollTop;
          }),
        ...
        o(e, [
          {
            ...
            value: function() {
              window.addEventListener(
                "scroll",
                l.default.throttle(this.onScroll, 250)
              );
            }
          },
          {
    ...
    (function(n) {
      ...
      (a.defineProperty =
        ...
        (a.initSymbolIterator = function() {
          ...
          e || (e = a.global.Symbol.iterator = a.global.Symbol("iterator")),
            "function" != typeof Array.prototype[e] &&
              a.defineProperty(Array.prototype, e, {
                configurable: !0,
                writable: !0,
                value: function() {
        ...
        (a.array = a.array || {}),
        (a.iteratorFromArray = function(e, t) {
      ...
      !(function(n, a) {
        ...
        function u(e, t) {
          var n,
            r = o(e);
          for (n in t) r[n] = R.und(e[n]) ? t[n] : e[n];
          return r;
        }
        function s(e) {
        ...
        function d(e, t) {
          return R.dom(e) && i(_, t)
            ? "transform"
            : R.dom(e) && (e.getAttribute(t) || (R.svg(e) && e[t]))
              ? "attribute"
              : R.dom(e) && "transform" !== t && b(e, t)
                ? "css"
                : null != e[t] ? "object" : void 0;
        }
        function P(e, n) {
          var r = S(n),
            r = -1 < n.indexOf("scale") ? 1 : 0 + r;
          if (((e = e.style.transform), !e)) return r;
          for (
            var i = [], o = [], a = [], l = /(\w+)\((.+?)\)/g;
            (i = l.exec(e));
        ...
        function m(e, t) {
          ...
          if (((n = R.pth(e) ? e.totalLength : e), R.col(n)))
            if (R.rgb(n)) {
              ...
              n = i ? "rgba(" + i[1] + ",1)" : n;
            } else n = R.hex(n) ? s(n) : R.hsl(n) ? c(n) : void 0;
          else
            (i = (i = T(n)) ? n.substr(0, n.length - i.length) : n),
        ...
        function B(e, t) {
          ...
          if (R.arr(e)) {
            var i = e.length;
            2 !== i || R.obj(e[0])
              ? R.fnc(t.duration) || (n.duration = t.duration / i)
              : (e = { value: e });
          }
          return r(e)
            .map(function(e, n) {
              return (
                (n = n ? 0 : t.delay),
                (e = R.obj(e) && !R.pth(e) ? e : { value: e }),
                R.und(e.delay) && (e.delay = n),
                e
              );
            })
            .map(function(e) {
        ...
        function D(e) {
          ...
          for (t in e)
            l.hasOwnProperty(t) ||
              "targets" === t ||
              o.push({ name: t, offset: l.offset, tweens: B(e[t], r) });
          return (
            (e = I(i, o)),
            u(n, {
              children: [],
        ...
        function O(e) {
          ...
          function i(e) {
            for (var n = 0, r = {}, i = f.animations, o = i.length; n < o; ) {
              ...
              for (
                var u =
                    ...
                    c.duration,
                  T = isNaN(u) ? 1 : c.easing(u, c.elasticity),
                  u = c.to.strings,
                  S = c.round,
                  s = [],
                  d = void 0,
                  d = c.to.numbers.length,
                  P = 0;
                P < d;
                P++
              ) {
                ...
                S && ((c.isColor && 2 < P) || (A = Math.round(A * S) / S)),
                  s.push(A);
              }
              if ((c = u.length))
                for (d = u[0], T = 0; T < c; T++)
                  (S = u[T + 1]),
                    (P = s[T]),
                    isNaN(P) || (d = S ? d + (P + S) : d + (P + " "));
              else d = s[0];
              F[a.type](l.target, a.property, d, r, l.id),
                (a.currentValue = d),
                n++;
            }
            if ((n = Object.keys(r).length))
              for (i = 0; i < n; i++)
                L ||
                  (L = b(document.body, "transform")
                    ? "transform"
                    : "-webkit-transform"),
                  (f.animatables[i].target.style[L] = r[i].join(" "));
          ...
          function l(e) {
            ...
            if (f.children.length) {
              var p = f.children,
                h = p.length;
              if (A >= f.currentTime) for (var M = 0; M < h; M++) p[M].seek(A);
              else for (; h--; ) p[h].seek(A);
            }
            (A >= b || !t) &&
        ...
        var L,
          ...
          k = (function() {
            ...
            return function(t, n, r, i) {
              if (0 <= t && 1 >= t && 0 <= r && 1 >= r) {
                ...
                if (t !== n || r !== i)
                  for (var a = 0; 11 > a; ++a) o[a] = e(0.1 * a, t, r);
                return function(a) {
                  if (t === n && r === i) return a;
                  if (0 === a) return 0;
                  if (1 === a) return 1;
                  for (var l = 0, u = 1; 10 !== u && o[u] <= a; ++u) l += 0.1;
                  --u;
                  var u = l + (a - o[u]) / (o[u + 1] - o[u]) * 0.1,
                    s =
                      3 * (1 - 3 * r + 3 * t) * u * u +
                      2 * (3 * r - 6 * t) * u +
                      3 * t;
          ...
          x = (function() {
            ...
            var t,
              ...
              i = { linear: k(0.25, 0.25, 0.75, 0.75) },
              o = {};
            for (t in r)
              (o.type = t),
                r[o.type].forEach(
          ...
          K = (function() {
            ...
            function t(t) {
              var n = X.length;
              if (n) {
                for (var r = 0; r < n; ) X[r] && X[r].tick(t), r++;
                e();
    ...
    var o = (function() {
      ...
      p = (function() {
        function e() {
          var t = this;
          i(this, e),
            (this.scrollToSection = function(e) {
        ...
        return (
          o(e, [
            ...
            },
            {
              key: "buildSections",
              value: function() {
                (this.header = new f.default(this.el.querySelector("#header"))),
                  (this.projectList = new d.default(
                    this.el.querySelector("#project-list")
                  ));
              }
            },
            {
            ...
            (this.onScroll = function() {
              if (!T.default.animating) {
                ...
                l.default.each(t.imageInfos, function(t) {
                  ...
                  t.hidden !== r &&
                    t.el.classList[(t.hidden = r) ? "add" : "remove"]("hidden");
                });
              }
            }),
            (this.onResize = function() {
          ...
          o(e, [
            {
              ...
              value: function() {
                (this.LazyLoader = new s.default({
                  ...
                  this.onResize(),
                  T.default.on("scroll", this.onScroll);
              }
            },
            {
      ...
      S = (function() {
        function e(t) {
          ...
          i(this, e),
            ...
            (this.togglePopin = function(e) {
              e.preventDefault();
              var t = !n.popinOpened;
              t
                ? (n.popinAbout.show(),
                  s.default.freeze(),
                  n.aboutButton.classList.add("opened"))
                : (n.popinAbout.hide(),
                  s.default.unfreeze(),
                  n.aboutButton.classList.remove("opened")),
                (n.popinOpened = t),
                n.updateState(!0);
            }),
              ...
              if (!s.default.animating) {
                ...
                if (r) {
                  ...
                  if (r.id != n.currentSectionId || e) {
                    ...
                    n.quickAccess.scrollDown.classList[i(a || n.popinOpened)](
                      o
                    ),
                      n.quickAccess.backToTop.classList[i(!a || n.popinOpened)](
                        o
                      ),
                      n.quickAccess.projects.classList[i(!u)](
                        o || n.popinOpened
                      ),
                      u &&
                        l.default.each(n.quickAccess.projectDots, function(e) {
                          var t = e.classList.contains("dot-" + r.id);
                          e.classList[i(t)]("current");
                        }),
                      (n.nav.style.color = r.color),
                      (n.quickAccess.projects.style.color = r.color),
                      (n.quickAccess.projects.style.borderColor = r.color),
                      (n.currentSectionId = r.id);
                  }
                }
              }
            }),
            (this.onResize = function() {
              (n.windowHeight = window.innerHeight),
                (n.currentSectionId = null),
                n.storeSectionInfos(),
                n.updateState();
            }),
            (this.sections = [].slice.call(t.parentNode.children)),
            this.sections.shift(),
            (this.aboutButton = t.querySelector(".about-button")),
            (this.nav = t.querySelector("header")),
            (this.el = t),
            (this.quickAccess = {
            ...
            this.aboutButton.addEventListener("click", this.togglePopin),
            this.duplicateAbout(),
            this.addEvents(),
            this.onResize();
        }
    ...
    var o = (function() {
      ...
      T = (function() {
        function e(t) {
          i(this, e),
            (this.el = t),
            (this.inner = t.querySelector(".inner-popin-about"));
        }
        return (
          o(e, [
            {
        ...
        function e(t) {
          ...
          i(this, e),
            (this.onMouseEnter = function(e) {
              ...
              (n.el.style.color = t.getAttribute("data-color")),
                (n.el.style.background = t.getAttribute("data-background"));
            }),
              ...
              value: function() {
                ...
                l.default.each(t, function(t) {
                  t.addEventListener("mouseenter", e.onMouseEnter),
                    t.addEventListener("mouseleave", e.onMouseLeave);
                });
              }
            }
          ]),
  ...
  function(e, t, n) {
    ...
    (r = e.exports = function(e, t) {
      ...
      return (
        ...
        null == e
          ? ((n = a = !0), (r = !1))
          : ((n = l.call(e, "c")), (r = l.call(e, "e")), (a = l.call(e, "w"))),
        (s = { value: t, configurable: n, enumerable: r, writable: a }),
        u ? i(o(u), s) : s
      );
    }),
      (r.gs = function(e, t, n) {
        ...
        return (
          ...
          null == t
            ? (t = void 0)
            : a(t)
              ? null == n ? (n = void 0) : a(n) || ((s = n), (n = void 0))
              : ((s = t), (t = n = void 0)),
          null == e
            ? ((r = !0), (u = !1))
            : ((r = l.call(e, "c")), (u = l.call(e, "e"))),
          (c = { get: t, set: n, configurable: r, enumerable: u }),
          s ? i(o(s), c) : c
        );
      });
  },
  ...
  function(e, t, n) {
    ...
    var r,
      ...
      p = { configurable: !0, enumerable: !1, writable: !0 };
    (r = function(e, t) {
      var n;
      return (
        T(t),
        A.call(this, "__ee__")
          ? (n = this.__ee__)
          : ((n = p.value = b(null)), d(this, "__ee__", p), (p.value = null)),
        n[e]
      ...
      (o = function(e, t) {
        var n, r, i, o;
        if ((T(t), !A.call(this, "__ee__"))) return this;
        ...
        if (A.call(this, "__ee__") && (i = this.__ee__[e]))
          if ("object" == typeof i) {
            for (n = arguments.length, o = new Array(n - 1), t = 1; t < n; ++t)
              o[t - 1] = arguments[t];
            for (i = i.slice(), t = 0; (r = i[t]); ++t) S.call(r, this, o);
          } else
      ...
      (l = { on: r, once: i, off: o, emit: a }),
      (u = { on: c(r), once: c(i), off: c(o), emit: c(a) }),
      (s = P({}, u)),
      ...
      e(function() {
        ...
        (o.mobileDetectRules = {
          ...
          tablets: {
            ...
            bqTablet:
              "Android.*(bq)?.*(Elcano|Curie|Edison|Maxwell|Kepler|Pascal|Tesla|Hypatia|Platon|Newton|Livingstone|Cervantes|Avant|Aquaris [E|M]10)|Maxwell.*Lite|Maxwell.*Plus",
            HuaweiTablet:
        ...
        return (
          ...
          (function() {
            ...
            for (e in c.props)
              if (l.call(c.props, e)) {
                for (
                  t = c.props[e], a(t) || (t = [t]), u = t.length, i = 0;
                  i < u;
                  ++i
                )
                  (n = t[i]),
          ...
          (o.findMatch = function(e, t) {
            for (var n in e) if (l.call(e, n) && e[n].test(t)) return n;
            return null;
          }),
          (o.findMatches = function(e, t) {
            var n = [];
            for (var r in e) l.call(e, r) && e[r].test(t) && n.push(r);
            return n;
          }),
          ...
          (o.isMobileFallback = function(e) {
            return (
              o.detectMobileBrowsers.fullPattern.test(e) ||
              o.detectMobileBrowsers.shortPattern.test(e.substr(0, 4))
            );
          }),
          ...
          (o.prepareDetectionCache = function(e, n, r) {
            if (e.mobile === t) {
              var a, l, u;
              return (l = o.findMatch(o.mobileDetectRules.tablets, n))
                ? ((e.mobile = e.tablet = l), void (e.phone = null))
                : (a = o.findMatch(o.mobileDetectRules.phones, n))
                  ? ((e.mobile = e.phone = a), void (e.tablet = null))
                  : void (o.isMobileFallback(n)
                      ? ((u = i.isPhoneSized(r)),
                        u === t
                          ? ((e.mobile = o.FALLBACK_MOBILE),
                            (e.tablet = e.phone = null))
                          : u
                            ? ((e.mobile = e.phone = o.FALLBACK_PHONE),
                              (e.tablet = null))
                            : ((e.mobile = e.tablet = o.FALLBACK_TABLET),
                              (e.phone = null)))
                      : o.isTabletFallback(n)
                        ? ((e.mobile = e.tablet = o.FALLBACK_TABLET),
                          (e.phone = null))
          ...
          (o.detectOS = function(e) {
            return (
              o.findMatch(o.mobileDetectRules.oss0, e) ||
              o.findMatch(o.mobileDetectRules.oss, e)
            );
          }),
          ...
          (i.prototype = {
            ...
            os: function() {
              return (
                this._cache.os === t && (this._cache.os = o.detectOS(this.ua)),
                this._cache.os
              );
            },
            version: function(e) {
            ...
            is: function(t) {
              return (
                ...
                e(t, this.phone()) ||
                e(t, this.tablet()) ||
                n(o.findMatches(o.mobileDetectRules.utils, this.ua), t)
              );
            },
            match: function(e) {
              return (
          ...
          (i._impl = o),
          (i.version = "1.3.7 2017-09-06"),
          i
        );
      });
    })(
      (function(t) {
        return "undefined" != typeof e && e.exports
          ? function(t) {
              e.exports = t();
            }
          : n(30);
    ...
    !(function() {
      function e() {
        ...
        return (
          ...
          (t = r ? document.documentElement : document.body)
        );
      }
      if (!document.scrollingElement) {
        var t = null;
        Object.defineProperty(document, "scrollingElement", { get: e });
      }
    })();
  },
  function(e, t, n) {
    ...
    !(function(o, l) {
      ...
      var e = {
        ...
        u = function(e, t, n) {
          return (
            (t === window ? window.pageYOffset : r(t)) >=
            r(e) + n + e.offsetHeight
          );
        },
        s = function(e, t, n) {
          return (
            (t === window ? window.pageXOffset : a(t)) >=
            a(e) + n + e.offsetWidth
          );
        },
        c = function(e, t, n) {
        ...
        f = function(e, t, n) {
          ...
          return "IFRAME" === r
            ? void (i && e.setAttribute("src", i))
            : void (i && (e.style.backgroundImage = 'url("' + i + '")'));
        },
        b = function(t) {
          (this._settings = o({}, e, t)),
      ...
      b.prototype = {
        _reveal: function(e) {
          var t = this._settings,
            r = function r() {
              t &&
                ...
                e.classList.remove(t.class_loading),
                e.classList.add(t.class_error),
                n(t.callback_error, e));
            },
            i = function i() {
              t &&
                (e.classList.remove(t.class_loading),
                e.classList.add(t.class_loaded),
                e.removeEventListener("load", i),
                e.removeEventListener("error", r),
                n(t.callback_load, e));
            };
          ("IMG" !== e.tagName && "IFRAME" !== e.tagName) ||
            ...
            e.classList.add(t.class_loading)),
        ...
        _loopThroughElements: function() {
          ...
          for (o = 0; o < i; o++) {
            var u = r[o];
            (e.skip_invisible && null === u.offsetParent) ||
              ((t || c(u, e.container, e.threshold)) &&
                (l && u.classList.add(e.class_initial),
                this._reveal(u),
                a.push(o),
                (u.dataset.wasProcessed = !0)));
          }
          for (; a.length; )
      ...
      return (
        d &&
          (function(e, t) {
            var n = t.length;
            if (n) for (var r = 0; r < n; r++) T(e, t[r]);
            else T(e, t);
          })(b, d),
        b
      );
